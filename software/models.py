...
def cli_main():
    ...
    study_results = study.best_params

    with open("./logs/custom_model_hp/hparm.txt","a+") as f:
        f.write(str(study_results))
    ...
    clf = Classifier.load_from_checkpoint("../logs_collection/logs_05_05_0850/custom_model_hp/version_2/checkpoints/epoch=49-step=799.ckpt")
