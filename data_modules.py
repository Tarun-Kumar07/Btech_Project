...
class Dvs128DataModule(pl.LightningDataModule):
    def __init__(self,data_dir,batch_size,num_workers,val_ratio):
        super().__init__()
        ...
        self.transforms = Compose([
            ToFrame(sensor_size=sensor_size,n_time_bins=3)
            ])
...
def test_dvs128_gesture():
    path = "../dvs128"
    dm = Dvs128DataModule(data_dir=path,batch_size=32,num_workers=8,val_ratio=0.1)
    dm.setup()
